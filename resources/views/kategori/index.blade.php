            ...
            <table class="table table-bordered">
              ...
              @foreach($itemkategori as $kategori)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('edit.kategori', $kategori->id) }}" class="btn btn-sm btn-primary mr-2 mb-2">
                      Edit
                    </a>
                    <form action="{{ route('destroy.kategori', $kategori->id) }}" method="post" style="display:inline;">
                      @csrf
                      {{ method_field('delete') }}
                      <button type="submit" class="btn btn-sm btn-danger mb-2">
                        Hapus
